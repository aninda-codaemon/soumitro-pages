;(function ($) {
  ...
  var validCVV = function(cvv) {
    ...
    var valid = true, cardType = checkCC(this.ccNum);
  ...
  var required = window.validators.required,
      ...
      withParams = window.vuelidate.withParams;

  window.validators.validMonthYear = withParams({type: 'validMonthYear'}, function(value){validMonthYear});
  window.validators.validCVV = withParams({type: 'validCVV'}, function(value){validCVV(value)});
  window.validators.validCC = withParams({type: 'validCC'}, function(value){validCC(value)});
  window.validators.validZip = withParams({type: 'validZip'}, function(value){validZip(value)});
  ...
  var propertyInfo = new Vue({
    ...
    methods: {
      ...
      submitHandler: function(e){
        ...
        if (this.$v.$invalid) {
          this.$v.$touch();
          //shouldn't use jquery here so should fix this scrolling eventually
