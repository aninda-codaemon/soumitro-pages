...
//   trackNL('Viewed Found Data Modal V1 B');
// }
...
/* Gets the page visited before */  
var referrer =  document.referrer;  
/* Change Modal back button behavior */
if(referrer.indexOf('numberguru') > -1){
  $("a.onBack").attr("href", "< =prev_page >");
}else{
  $("a.onBack").attr("href", "< =flow_home_page >");  
}
