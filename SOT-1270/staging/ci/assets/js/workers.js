(function () { "use strict";
    ...
    var reportHeap = function (evtType, evtProp) {
        if (typeof heap !== "undefined" && heap.track) {
            heap.track(evtType, evtProp)
        }
    };
    ...
    var startValidation = function () {
        ...
        $("#signup-account-form form").validate({
            validClass: "success",
        ...
        $("#signup-spages-form form").validate({
            validClass: "success",
            ...
            submitHandler: function (form) {
                ...
                reportHeap("Submitted Lead Form - People");
