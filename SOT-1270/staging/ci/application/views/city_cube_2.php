    ...
    <div id="info-body-person" class="container no-bottom">
        <div class="row">
            <div class="col-sm-6 col-md-8">
                <div class="dir-wrap">
                    <p class=""><strong>Browse Profiles in <?php echo ul($city); ?>, <?php echo ul($state); ?> From <?php echo p($lowlast) . ", " . p($lowfirst) . " to " . p($highlast) . ", " . p($highfirst); ?></strong></p>
                    <div>
                        <ul class="row">
                            <!-- begin include -->
                            <?php
                            ...
                            ?>
                            <li class="col-md-6"><a href="<?php echo "/" . $state . "/" . $city . "/" . $bucket["x"] . "/". $bucket["y"]; ?>"><?php echo p($bucket["lowlast"]) . ", " . p($bucket["lowfirst"]) . " - " . p($bucket["highlast"]) . ", " . p($bucket["highfirst"]); ?></a></li>
                            <?php
                            }
                            ?>
                            <!-- end include -->
