<!DOCTYPE html>
    <head>
        ...
        <link rel="stylesheet" href="//manaron.s3.amazonaws.com/srg/seo-redux/css/bootstrap.min.css">
        <link rel="stylesheet" href="//manaron.s3.amazonaws.com/srg/seo-redux/css/seo-main.css">

        <!--[if lt IE 9]>
            <script src="//oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
            <script src="//manaron.s3.amazonaws.com/srg/Reverse-Phone/landing/js/respond.min.js"></script>
        <![endif]-->
    </head>
    ...
    <!-- End Google Tag Manager -->    
        ...
        <header class="container">
            <div class="row">
                <a href="#" id="logo-header" class="pull-left" title="BeenVerified"></a>
                <div class="visible-xs pull-right">
                    <a id="menu-dropdown" class="btn btn-default"><span class="glyphicon glyphicon-align-justify"></span></a>
                </div>
            ...
            <div  class="container">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <form id="header-search" class="row" role="form">
                            <div class="col-md-4">
                ...
                <div class="row hidden-xs hidden-sm">
                    <div class="as-seen-on-wrapper col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <img src="//manaron.s3.amazonaws.com/srg/seo-redux/img/press/inc-logo.png" class="img-center img-responsive">
                            </div>
                            <div class="col-md-1">
                                <img src="//manaron.s3.amazonaws.com/srg/seo-redux/img/press/cnet-logo.png" class="img-center img-responsive">
                            </div>
                            <div class="col-md-2">
                                <img src="//manaron.s3.amazonaws.com/srg/seo-redux/img/press/tc-logo.png" class="img-center img-responsive">
                            </div>
                            <div class="col-md-3">
                                <img src="//manaron.s3.amazonaws.com/srg/seo-redux/img/press/nyt-logo.png" class="img-center img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="bread-crumbs-wrapper" class="container hidden-xs hidden-sm">
<?php
...
?>
		<span itemprop="breadcrumb"><?php echo $level["title"]; ?></apan>
<?php
if (!empty($level["url"])) {
?>
			</a> &gt;
