    ...
    <div id="info-body-person" class="container no-bottom">
        <div class="row">
            <div class="col-sm-6 col-md-8">
                <div class="dir-wrap">
                    <p class=""><strong>Browse Profiles in <?php echo ul($state); ?> From <?php echo p($lowfirst) . " " . p($lowlast) . " to " . p($highfirst) . " " . p($highlast); ?></strong></p>
                    <div>
                        <ul class="row">
                            <!-- begin include -->
                            <?php
                            ...
                            ?>
                            <li class="col-md-6"><a href="/<?php echo $state . "/" . $bucket["first"] . "-". $bucket["last"]; ?>"><?php echo p($bucket["first"]) . " " . p($bucket["last"]); ?></a></li>
                            <?php
                            }
                            ?>
                            <!-- end include -->
