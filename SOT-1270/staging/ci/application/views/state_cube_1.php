<?php
$info["h1"] = "Browse All Profiles In ".ul($state)."";
$info["title"] = "All Profiles In ".ul($state)."";
$info["description"] = "Browse all profiles in ".ul($state)." at BeenVerified.com, your people search and background check answer.";
                ...
                <div class="dir-wrap">
                    ...
                    <div>
                        <ul class="row">
                            ...
                            ?>
                            <li class="col-md-6"><a href="<?php echo "/" . $state . "/" . $bucket["x"]; ?>"><?php echo p($bucket["lowlast"]) . ", " . p($bucket["lowfirst"]) . " - " . p($bucket["highlast"]) . ", " . p($bucket["highfirst"]); ?></a></li>
                            <?php
                            }
                            ?>
                            <!-- end include -->
