<?php
$info["h1"] = "Find People in ".ul($state)."";
$info["title"] = "".ul($state)." People Search | BeenVerified.com";
$info["description"] = "Find people in ".ul($state)." at BeenVerified.com, your people search and background check answer.";
    ...
    <div id="info-body-person" class="container no-bottom">
        <div class="row">
            <div class="col-sm-6 col-md-8">
                <div class="dir-wrap">
                    <p><strong>Find People in <?php echo ul($state); ?></strong></p>
                ...
                <div class="dir-wrap">
                    <p class=""><strong>Most Populated Cities in <?php echo ul($state); ?></strong> <a href="<?php echo "/" . $state . "/"; ?>cities">Browse All Cities in <?php echo ul($state); ?></a></p>
                    <div>
                        <ul class="row">
                            <!-- begin include -->
                            <?php
                            ...
                            ?>
                            <li class="col-md-4"><a href="<?php echo "/" . $state . "/" . str_replace(" ", "-", $topcity["city"]); ?>"><?php echo p($topcity["city"]) . " - " . $topcity["personcount"]; ?></a></li>
                            <?php
                            }
                            ?>
                            <!-- end include -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="dir-wrap">
                    <p class=""><strong>Most Popular Names in <?php echo ul($state); ?></strong> <a href="<?php echo "/" . $state . "/"; ?>profiles">Browse All Profiles in <?php echo ul($state); ?></a></p>
                    <div>
                        <ul class="row">
                            <!-- begin include -->
                            <?php
                            ...
                            ?>
                            <li class="col-md-3"><a href="<?php echo "/" . $state . "/" . $topname["first"] . "-" . $topname["last"]; ?>"><?php echo p($topname["first"]) . " " . p($topname["last"]) . " - " . p($topname["personcount"]); ?></a></li>
                            <?php
                            }
                            ?>
                            <!-- end include -->
