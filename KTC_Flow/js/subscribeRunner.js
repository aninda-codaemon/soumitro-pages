...
;(function (w, $) {
  var VERIFI_ENDPOINT = w.BV_VERIFI_ENDPOINT || 'https://secure.verifi.com/api/v2/three-step/',
      ...
      REDIRECT_IDENTIFIER = 'knowthycustomer.com';
...
;(function (w, $, _) {
  ...
  var BV_ENDPOINT = w.BV_ENDPOINT_URL || 'https://www.knowthycustomer.com/api/v4/account.json';
 ...
 */
 ;(function (w, $) {
    ...
    var validatorRules = {
      ...
      "business_contact[contact_phone]":{
        required: true,
        number: true,
      },
    ...
    var applyValidation = function (formSelector) {
      ...
      var validatorOpts = {
        ...
        messages: {
          ...
          "business_contact[company]": "Please enter your company name.",
          "business_contact[job_title]": "Please enter your job title.",
          "business_contact[contact_phone]": "Please enter your phone number.",
          "credit_card[verification_number]": {
      ...
      if (ignoreMessages === true) {
        ...
        validatorOpts.errorPlacement = function (error, element) {
          ...
          } else if (name === "credit_card[card_number]" || name === "credit_card[verification_number]" || name === "address[zip]" || name === "credit_card[expiration_date(1i)]" || name === "credit_card[expiration_date(2i)]"){
...
;(function (w, $) {
  ...
  var SIGNUP_REDIRECT_URL = w.BV_SIGNUP_REDIRECT_URL || '//www.knowthycustomer.com/accounts/creating_account',
  ...
  var handleProcessingError = function (errors) {
    var $errorContainer = $('#error_container'),
        $errorMessages = $('#error_container .messages'),
        errorLen = 0,
        i = 0;
